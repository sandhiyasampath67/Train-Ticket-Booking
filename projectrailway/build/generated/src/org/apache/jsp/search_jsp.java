...
public final class search_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("</head>\n");
      out.write("    <body style=\"background-color:#DB1A3A;\">\n");
      out.write("    \n");
      out.write("<div style=\"float: right;margin-right: 300px;\">\n");
      out.write("\t\t\t<div class=\"del\">\n");
      out.write("\t\t\t  <h1>Search Train</h1>\n");
      out.write("\t\t\t  <form>\n");
      out.write("\t        \t<input type=\"text\" name=\"Trainname\" placeholder=\"Train Name\">\n");
      out.write("\t        \t<br />\n");
      out.write("\t        \t<br />\n");
      ...
      out.write("\t            ");
	                ...
	                String query="select * from admintrain where Trainname='"+request.getParameter("Trainname")+"'";
	                ResultSet rs = null;
